...
public class ReportServiceTests
{
    ...
    private sealed class InMemoryAttendanceRepository : IAttendanceRepository
    {
        ...
        public Task<IReadOnlyList<AttendanceRecord>> GetByStudentAndRangeAsync(int studentId, DateTime startDate, DateTime endDate, CancellationToken cancellationToken = default) => Task.FromResult<IReadOnlyList<AttendanceRecord>>(Records.Where(r => r.StudentId == studentId).ToList());
