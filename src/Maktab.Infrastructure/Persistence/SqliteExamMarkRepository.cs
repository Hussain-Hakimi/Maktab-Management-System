...
{
    public async Task<IReadOnlyList<ExamMark>> GetMarksByClassAndSubjectAsync(
        int classId,
        int subjectId,
...
WHERE StudentID = $studentId AND AcademicYearId = $academicYearId;";
    ...
    public async Task<IReadOnlyList<ExamMark>> GetMarksByClassAsync(
        int classId,
        CancellationToken cancellationToken = default)
    {
        const string sql = @"
...
WHERE s.ClassID = $classId;";
    ...
    public async Task SaveOrUpdateMarksBatchAsync(
        IEnumerable<ExamMark> marks,
        CancellationToken cancellationToken = default)
    {
